...
const dictionaries: Record<Lang, Dict> = {
  ro: {
    ...
    "help.title": "Centru Ajutor",
    "help.subtitle": "Cum te putem ajuta astăzi? Găsește răspunsuri la întrebări comune și ghiduri pentru a folosi Skyff.io eficient.",
    "help.gettingStarted.title": "Ghid de început",
    "help.gettingStarted.desc": "Învață bazele Skyff.io și cum să îți configurezi contul.",
    "help.faqs.title": "Întrebări frecvente",
    "help.faqs.desc": "Găsește răspunsuri rapide la cele mai frecvente întrebări.",
    "help.support.title": "Contactează suportul",
    "help.support.desc": "Ai nevoie de mai mult ajutor? Echipa noastră de suport este aici pentru tine 24/7.",
    "releases.title": "Noutăți",
    "releases.subtitle": "Fii la curent cu cele mai noi funcționalități, îmbunătățiri și corecții.",
  ...
  ru: {
    ...
    "help.subtitle": "Как мы можем помочь вам сегодня? Найдите ответы на общие вопросы и руководства по эффективному использованию Skyff.io.",
    "help.gettingStarted.title": "Начало работы",
    "help.gettingStarted.desc": "Изучите основы Skyff.io и узнайте, как настроить свой аккаунт.",
    "help.faqs.title": "Часто задаваемые вопросы",
    "help.faqs.desc": "Найдите быстрые ответы на самые часто задаваемые вопросы.",
    "help.support.title": "Связаться с поддержкой",
    "help.support.desc": "Нужна дополнительная помощь? Наша служба поддержки работает для вас 24/7.",
    "releases.title": "Обновления",
    "releases.subtitle": "Будьте в курсе последних функций, улучшений и исправлений ошибок.",
  ...
  en: {
    ...
    "help.subtitle": "How can we help you today? Find answers to common questions and guides to use Skyff.io effectively.",
    "help.gettingStarted.title": "Getting Started",
    "help.gettingStarted.desc": "Learn the basics of Skyff.io and how to set up your account.",
    "help.faqs.title": "FAQs",
    "help.faqs.desc": "Find quick answers to the most frequently asked questions.",
    "help.support.title": "Contact Support",
    "help.support.desc": "Need more help? Our support team is here for you 24/7.",
    "releases.title": "Release Notes",
    "releases.subtitle": "Stay up to date with the latest features, improvements, and bug fixes.",
